...
MAP_DIR = ASSET_ROOT / "map"
FONT_PATH = GRAPHICS_DIR / "font" / "joystix.ttf"
...
weapon_data = {
    "sword": {
        "cooldown": 100,
        "damage": 15,
        "graphic": str(GRAPHICS_DIR / "weapons" / "sword" / "full.png"),
    },
    "lance": {
        "cooldown": 400,
        "damage": 30,
        "graphic": str(GRAPHICS_DIR / "weapons" / "lance" / "full.png"),
    },
    "axe": {
        "cooldown": 300,
        "damage": 20,
        "graphic": str(GRAPHICS_DIR / "weapons" / "axe" / "full.png"),
    },
    "rapier": {
        "cooldown": 50,
        "damage": 8,
        "graphic": str(GRAPHICS_DIR / "weapons" / "rapier" / "full.png"),
    },
    "sai": {
        "cooldown": 80,
        "damage": 10,
        "graphic": str(GRAPHICS_DIR / "weapons" / "sai" / "full.png"),
    },
}
...
magic_data = {
    "flame": {
        "strength": 5,
        "cost": 20,
        "graphic": str(GRAPHICS_DIR / "particles" / "flame" / "fire.png"),
    },
    "heal": {
        "strength": 20,
        "cost": 10,
        "graphic": str(GRAPHICS_DIR / "particles" / "heal" / "heal.png"),
    },
}
